...
$spezzone=$_POST['spezzone']; 
$film_completo=$_POST['film'];
...
$query= "INSERT INTO movies (spezzone, film, collegamento, sentimento, scena, fattoreL, valore_i, valore_im, valore_f, valore_cm, valore_c) 
VALUES ('{$spezzone}','{$film}','{$collegamento}','{$sentimento}','{$scena}','{$fattore_L}', '{$i}', '{$im}', '{$f}', '{$cm}', '{$c}' )";
...
<label>Nome spezzone</label><input type="text" name="spezzone" placeholder="inserisci il nome dello spezzone"  /><br/>

<label>Nome film</label><input type="text" name="film" placeholder="inserisci il nome del film"  /><br/>
<label>sentimento</label><input type="text" name="sentimento" placeholder="inserisci il sentimento"  /><br/>

<label>iFrame movies (da Youtube)</label><input type="text" name="collegamento" placeholder="inserisci il collegamento alla canzone"  /><br/>
