	...
	if($fattoreU <= rand(1, 10000)) {
		...
		//if (!cont_iframe(row['idiFrame']) {
			...
			if ($row['fattore_L']<= rand(1, 10000)) {
				...
				if($row['canzone']=="") {echo "manca la canzone";}
				...
				echo '<a href="processing.php">vai indietro</a>';
				
		?>
		
		
				<form action="primo_step.php" method="post" >
			...
			<input type="submit" name="submit" value="vai al primo colpo di scena" />
			</form>
			<br/>
