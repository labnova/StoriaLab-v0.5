	...
	if($fattoreU <= rand(1, 10000)) {
		...
		//if (!cont_iframe(row['idiFrame']) {
			...
			if ($row['fattore_L']<= rand(1, 10000)) {
				...
				echo '<a href="primo_step.php">vai indietro</a>';
				
				
		?>
		
		
				<form action="sec_step.php" method="post" >
			...
			<input type="submit" name="submit" value="vai al secondo colpo di scena" />
			</form>
			<br/>
